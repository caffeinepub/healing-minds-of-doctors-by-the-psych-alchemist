...
export class Backend implements backendInterface {
    ...
    async getAndroidAPK(): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getAndroidAPK();
    ...
    async setAndroidAPK(arg0: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setAndroidAPK(to_candid_opt_n7(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
